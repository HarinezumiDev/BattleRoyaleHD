...
## Configuration
Plugin can be configured due the `config.yml` file which includes all possible settings. The file will be automatically generated by starting the server with **BattleRoyaleHD** 
